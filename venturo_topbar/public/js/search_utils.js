...
import { fuzzy_match } from "/assets/frappe/js/frappe/ui/toolbar/fuzzy_match.js";
...
venturo_topbar.search.utils = {
	...
	/**
	 * @deprecated Use venturo_topbar.search.utils.fuzzy_search(subseq, str, true).marked_string instead.
	 */
